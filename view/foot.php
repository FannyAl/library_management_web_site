<div class="navbar-fixed-bottom">
  <footer>
    ...
    <p>
      <a href="../index.php"><i class="icon-comment"></i>&nbsp;Nous contacter  &nbsp;  </a>
      - &nbsp;
      <a href="#"><i class="icon-question-sign"></i>&nbsp;Foire aux questions  &nbsp;  </a>
      - &nbsp;
      <a href="#"><i class="icon-briefcase"></i>&nbsp;Mentions légales  &nbsp;  </a>
      - &nbsp;
      <a href="#"><i class="icon-info-sign"></i>&nbsp;A propos  &nbsp;  </a>
    </p>
  ...
  <script src="lib/js/jquery-migrate-1.0.0.min.js"></script>
  ...
  <script src="../lib/js/jquery.flot.resize.min.js"></script>
    ...
    <script src="../lib/js/jquery.knob.modified.js"></script>
    ...
    <script src='../lib/js/impression.js'></script>
